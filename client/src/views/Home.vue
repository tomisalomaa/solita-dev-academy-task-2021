  ...
  <div class="home">
    <v-container fluid>
      <v-row class="mb-12 mt-2" justify="center">
        <h1>Welcome to Vaccination Data Central</h1>
      </v-row>
    </v-container>
    ...
    <v-container fluid v-if="loaded">
          ...
          <v-simple-table>
            <thead>
              <tr>
                ...
                <th class="text-center">Potential injections from orders</th>
                <th class="text-center">Injections administered</th>
      ...
      <v-row class="mt-8">
        ...
        <v-col md="3" align="center">
          ...
          <Piechart
            :chartData="this.totalOrdersByDist"
        ...
        <v-col md="3" align="center">
          ...
          <Piechart
            :chartData="this.totalInjectionsByDist"
            :chartLabels="this.healthcareDists"
          />
        </v-col>
        <v-spacer />
