const schemas = require("../models/vaccination");

describe("Vaccination schema attributes match database document attributes", () => {
...
describe("Antiqua schema attributes match database document attributes", () => {
...
describe("Solarbuddhica schema attributes match database document attributes", () => {
    test("'orderNumber' matches", () => {
...
describe("Zerpfy schema attributes match database document attributes", () => {
    test("'orderNumber' matches", () => {
